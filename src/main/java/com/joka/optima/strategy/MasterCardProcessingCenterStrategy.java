...
@Component
public class MasterCardProcessingCenterStrategy implements CardProcessingCenterStrategy {
    private static final String MASTERCARD_PREFIX = "5";
    private static final int VALID_YEARS = 5;

    private final int cardNumberLength;
    private final CardOperationValidator validator;

    public MasterCardProcessingCenterStrategy(
    ...
    public PaymentSystemCode supportedSystem() {
        return PaymentSystemCode.MASTERCARD;
    }
    ...
    private String generateCardNumber() {
        StringBuilder cardNumber = new StringBuilder(MASTERCARD_PREFIX);
